...
public class AditionalTest {
    ...
    public void addEdgeTest(){
        ...
        Assert.assertEquals(graph1.getEdgeNumber(), 6);
        Assert.assertEquals(graph2.getEdgeNumber(), 10);
        graph2.addEdge(70L, 80L);
        Assert.assertEquals(graph2.getEdgeNumber(), 11);
    ...
    public void addWeightedEdgeTest(){
        ...
        Assert.assertEquals(weightedGraph.getEdgeNumber(), 7);

    }

    @Test
    public void toStringTest(){
        Assert.assertEquals(graph1.toString(), "1 - [1-->2, 1-->5]\n" +
                "2 - [2-->1, 2-->5]\n" +
                "3 - [3-->5]\n" +
                "4 - [4-->5]\n" +
                "5 - [5-->2, 5-->3, 5-->4, 5-->1]\n");
        Assert.assertEquals(graph2.toString(), "50 - [50-->20, 50-->70]\n" +
                "40 - [40-->10, 40-->20]\n" +
                ...
                "70 - [70-->60, 70-->50]\n");
        Assert.assertEquals(weightedGraph.toString(), "5 - [5-->2(0.2), 5-->3(5.0), 5-->4(2.3), 5-->1(1.0)]\n" +
                "3 - [3-->5(5.0), 3-->4(-9.5)]\n" +
                "2 - [2-->1(0.1), 2-->5(0.2)]\n" +
                "4 - [4-->3(-9.5), 4-->5(2.3)]\n" +
                "1 - [1-->2(0.1), 1-->5(1.0)]\n");
